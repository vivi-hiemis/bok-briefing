...
function Cover() {
  return (
    <div className="slide" style={{ background: 'var(--bok-navy-900)', color: 'var(--white)', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      {/* 상단 골드 라인 */}
      <div style={{ position: 'absolute', top: 120, left: '50%', transform: 'translateX(-50%)', width: 80, height: 3, background: 'var(--accent-gold)' }} />
      ...
      <div style={{ position: 'absolute', bottom: 90, left: '50%', transform: 'translateX(-50%)', textAlign: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14 }}>
          ...
          <svg width="40" height="40" viewBox="0 0 40 40" style={{ flexShrink: 0 }}>
            <circle cx="20" cy="20" r="18" fill="none" stroke="var(--accent-gold)" strokeWidth="1.5" />
            <text x="20" y="26" textAnchor="middle" fontSize="16" fontWeight="700" fill="var(--accent-gold)" fontFamily="Georgia, serif">B</text>
          </svg>
