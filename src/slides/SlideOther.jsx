      ...
      <div style={{ marginTop: 10, background: 'var(--white)', border: '1px solid var(--ink-200)', padding: '12px 20px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 8 }}>
          ...
          <div style={{ display: 'flex', gap: 14, fontSize: 11, color: 'var(--ink-700)', fontWeight: 600 }}>
            <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}><span style={{ width: 10, height: 10, background: 'var(--accent-blue-deep)' }}/>당행 주관</span>
            ...
            {events.map((e, i) => {
              ...
              return (
                <div key={i} style={{ gridColumn: `${col + 1} / span ${span}`, gridRow: stackIdx + 1, paddingRight: 4 }}>
                  <div style={{ background: gold ? 'oklch(80% 0.10 235 / 0.18)' : 'var(--bok-navy-050)', borderLeft: `3px solid ${gold ? 'var(--accent-blue-deep)' : 'var(--bok-navy-900)'}`, padding: '7px 10px' }}>
                    <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 6 }}>
                      ...
                      <div className="mono tnum" style={{ fontSize: 10, color: gold ? 'var(--accent-blue-deep)' : 'var(--bok-navy-700)', fontWeight: 800 }}>{e.d}</div>
                    </div>
            ...
            {achievements.map((g, gi) => (
              <div key={gi} style={{ display: 'flex', flexDirection: 'column', marginBottom: 6 }}>
                <div style={{
                  ...
                  borderBottom: `2px solid ${g.accent ? 'var(--accent-blue-deep)' : 'var(--bok-navy-700)'}`,
                  paddingBottom: 3, marginBottom: 4,
                }}>
                  <span style={{ width: 4, height: 11, background: g.accent ? 'var(--accent-blue-deep)' : 'var(--bok-navy-700)' }}/>
        ...
        <div style={{ background: 'var(--white)', border: '1px solid var(--ink-200)', padding: '14px 18px 14px', display: 'flex', flexDirection: 'column', minHeight: 0 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 8, paddingBottom: 6, borderBottom: '2px solid var(--bok-navy-900)' }}>
            ...
            <div style={{ display: 'flex', gap: 10, alignItems: 'baseline' }}>
              ...
              <div className="mono tnum" style={{ fontSize: 11, color: 'var(--accent-blue-deep)', fontWeight: 800 }}>중점 {keyPlan}</div>
            </div>
          </div>
              ...
              <div key={gi} style={{ display: 'flex', flexDirection: 'column', marginBottom: 6 }}>
                ...
                {g.items.map((it, ii) => (
                  <div key={ii} style={{
                    ...
                    <div style={{
                      fontSize: 8, fontWeight: 800, color: it.k ? 'var(--accent-blue-deep)' : 'var(--ink-400)',
                    ...
                    <div style={{
                      ...
                      {it.t}
                      {it.k && <span className="mono" style={{ fontSize: 8, color: 'var(--accent-blue-deep)', marginLeft: 4, fontWeight: 800, letterSpacing: '0.1em' }}>[중점]</span>}
                    </div>
                  </div>
                ))}
              </div>
